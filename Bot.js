...
vk.setOptions({
    token: 'e2c9805cc3ac5eb55199aa6554e8383122b16a3f163beec34024e5ff945fc7c1d4546d8e1419551d890b2', // токен группы
    apiMode: 'parallel',
    pollingGroupId: 180884630 // 1 замени на id группы 
}); 
...
vk.updates.use(async (message, next) => {  
    ...
    if(!uid[message.user]){
		...
		message.send(`🎉 ➾ *id${message.user}, вы успешно зарегистрировались!\n📝 ➾ "Помощь" - список команд.\n📝 ➾ Чтобы не пропустить обновление проекта вы должны быть подписаны на нашу группы: "@club180884630 (Барик Бот)"`)
